...
class GCNModelAE(Model):
    ...
    def __init__(self, placeholders, num_features, features_nonzero,hidden,dimension,fastgae, **kwargs):
    ...
    def _build(self):
        ...
        self.z_mean = GraphConvolution(input_dim = self.hidden,
        ...
        self.reconstructions = InnerProductDecoder(fastgae = self.fastgae, # Whether to use FastGAE
        ...
        self.clusters = DistanceDecoder(fastgae = self.fastgae, # Whether to use FastGAE
                                        sampled_nodes = self.sampled_nodes, # FastGAE subgraph
                                        act = lambda x: x,
                                        logging = self.logging)(self.z_mean)
...
class GCNModelVAE(Model):
    ...
    def __init__(self, placeholders, num_features, num_nodes, features_nonzero,hidden,dimension,fastgae, **kwargs):
    ...
    def _build(self):
        ...
        self.z_log_std = GraphConvolution(input_dim = self.hidden,
                                          output_dim = self.dimension,
                                          adj = self.adj_layer2,
                                          act = lambda x: x,
                                          dropout = self.dropout,
        ...
        self.z = self.z_mean + tf.random_normal([self.n_samples, self.dimension]) * tf.exp(self.z_log_std)
...
class LinearModelAE(Model):
    ...
    def __init__(self, placeholders, num_features, features_nonzero,dimension,fastgae, **kwargs):
...
class LinearModelVAE(Model):
    ...
    def __init__(self, placeholders, num_features, num_nodes, features_nonzero,dimension,fastgae, **kwargs):
