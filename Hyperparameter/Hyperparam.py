...
# %%
Graph, attr, num_comu = Load_Graph('Graph_Generation/Graph_mu_Hyper/',0.1)
Graph2, attr2, num_comu2 = Load_Graph('Graph_Generation/Graph_mu_Hyper/',0.7)
...
netmf_args = dict (dimensions= [128],
                    ...
                    order= [1,2,3])
randne_args = dict (alphas=[[round(i,2),round(j,2)]
...
def Tune(Algorithm,grid ,special= None, scoring = AMI):
    ...
    with open(f'Hyperparameter/Hyperparams_results/{Algorithm.__name__}.txt','w') as f:
...
if __name__ == '__main__':
    ...
    for A in Algos:
        ...
        save_checkpoint({'Check_A':A.__name__}, 'Hyperparameter/Check.chkp')